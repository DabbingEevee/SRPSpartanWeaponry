...
import com.existingeevee.swparasites.handlers.LongbowArrowHandler;
...
import com.existingeevee.swparasites.init.weapons.ParasiteSWHijackedIron;
...
public class SRPSpartanWeaponry {
	...
	public void onPreInit(FMLPreInitializationEvent event) {
		...
		MinecraftForge.EVENT_BUS.register(LongbowArrowHandler.class);
		...
		MinecraftForge.EVENT_BUS.register(ParasiteSWHijackedIron.class);
