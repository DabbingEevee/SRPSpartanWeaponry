...
public class ItemParasiteThrowingKnife extends ItemThrowingKnife {

	public ItemParasiteThrowingKnife(String unlocName, String externalModId, ToolMaterialEx material) {
